...
if __name__ == '__main__':
    ...
    config_str = " --config=EMU_sc2_cds" # algorithm
    #env_str    = " --env-config=academy_3_vs_1_with_keeper"  #
    env_str    = " --env-config=sc2"  #
    ...
    with open(os.path.join(os.path.dirname(__file__), "config", "default.yaml"), "r") as f:
        try:
            ...
            #config_dict = yaml.load(f, encoding='CP949') # for text, csv
            #with open(f, 'rt', encoding='utf8') as yml:
            config_dict = yaml.safe_load(f)
